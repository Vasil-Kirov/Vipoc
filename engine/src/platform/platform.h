...
#define MAX_PATH PATH_MAX
	...
	// Pass "0" for path to write to stdout or "1" for stderr
	// If the function returns false that means a new file was created to write the data
	// or the write was not successful
	VP_API bool32
