...
#define DEFINE_MBUTTON(name, code) VP_MOUSE_BUTTON_##name = code
    
    
    typedef enum buttons
    {
        DEFINE_MBUTTON(LEFT, 0x01),
        DEFINE_MBUTTON(RIGHT, 0x02),
        DEFINE_MBUTTON(MIDDLE, 0x04),
        DEFINE_MBUTTON(XBUTTON1, 0x05),
        DEFINE_MBUTTON(XBUTTON2, 0x06)
    } buttons;
